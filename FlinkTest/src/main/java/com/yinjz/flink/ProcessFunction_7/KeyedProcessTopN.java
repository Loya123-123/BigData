...
import com.yinjz.flink.TimeWindow_6.UrlViewCount;
...
public class KeyedProcessTopN {
    ...
    public static void main(String[] args) throws Exception {
        ...
        KeyedStream<UrlViewCount, Long> urlViewCountLongKeyedStream = urlCountStream.keyBy(data -> data.windowEnd);
        SingleOutputStreamOperator<String> result = urlViewCountLongKeyedStream.process(new TopN(2));
